 ...
 <body>
       ...
       <nav class="navbar navbar-expand-lg navbar-dark text-dark   bg-dark text-center text-white">
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">Notra.com</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="pdftest.php">PDF</a>
              </li>
          ...
          <li class="nav-item ">
           ...
           <a class="btn btn-secondary dropdown-toggle" href="#" id="dropdownMenuButton" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <form action="code.php"method="POST">
              <a class="dropdown-item" name="ChangePassword" href="userproduct.php">View Books</a>
              <a class="dropdown-item" href="useraddbook.php">Add Books</a>
