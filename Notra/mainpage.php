     ...
     <div class="video--wrap">
         <div id="video">
            ...
            <div class="caption text-center d-block ">
              ...
              <div class="d-inline "><a href="Notra/admin/login.php" class="text-white btn btn-primary   ">Log In</a></div>
              <div class="d-inline "> <a href="Notra/signupdemo.php" class="text-white btn btn-danger btn-md  ">SignUp</a></div>
      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              <li clss="d-inline">
                <a href="Discovering-nepal/admin/login.php" class="text-white btn btn-primary   ">Log In</a> 
              </li>
              <li class="pt-1">
                <a href="Discovering_nepal/signupdemo.php" class="text-white btn btn-danger btn-md  ">SignUp</a>
              </li>
              <li>
