...
if (!$status_result) {
    die('Error in SQL query: ' . mysqli_error($conn));
        ...
        $output .= '<button class="btn btn-light bg-success" style="margin:10px;"><input type="button" value="Like" id="like_'.$postid.'" class="like border-collapse bg-success" style="'.($type == 1 ? "color: #ffa449;" : "").';border:none;" /> <i id= "like_'.$postid.'_icon" style="'.($type == 1 ? "color: #ffa449;" : "").'" class="fa">&#xf087;</i>&nbsp;(<span id="likes_'.$postid.'">'.$total_likes.'</span>)&nbsp;</button>';
