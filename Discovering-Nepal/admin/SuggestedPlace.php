              ...
              <div class="modal-content">
                ...
                <form action="pcode.php" method="POST">
                          ...
                          <div class="modal-footer">
                                    ...
                                    <button type="submit" name="UDeleteplace" class="btn btn-primary">yes </button>
                          </div>
                                                                        ...
                                                                        foreach($query_run as $row)
                                                                        {
                                                                            ...
                                                                            ?>
                                                                                 <tr>
                                                                                        ...
                                                                                        <td>
                                                                                        <a class="btn btn-primary edit" name="ChangePassword" href="PlaceEdit.php?p_id=<?php  echo  $row['p_id'];?>">Edit</a>
